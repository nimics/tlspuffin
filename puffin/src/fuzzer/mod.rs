...
use crate::{protocol::ProtocolBehavior, trace::Trace};
...
// LibAFL support
impl<M: Matcher, PB: ProtocolBehavior> Input for Trace<M, PB> {
...
impl<M: Matcher, PB: ProtocolBehavior> HasLen for Trace<M, PB> {
    fn len(&self) -> usize {
        self.steps.len()
    }
}
